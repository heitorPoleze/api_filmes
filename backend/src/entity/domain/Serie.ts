...
export class Serie extends Obra {
    ...
    constructor(id: number, name: string, overview: string, nota: number, equipe: Array<Participacao>, genres: Array<string>, number_of_episodes: number, number_of_seasons: number, imgLink?: string, release_date?: string){
